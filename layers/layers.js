...
lyr_PENDIDIKAN_PT_50K_1.set('fieldImages', {'NAMOBJ': 'TextEdit', 'LUAS': 'TextEdit', 'KATPDK': 'Range', 'JLPDDK': 'Range', 'FGGPDK': 'Range', 'REMARK': 'TextEdit', 'FCODE': 'TextEdit', 'SRS_ID': 'TextEdit', 'LCODE': 'TextEdit', 'METADATA': 'TextEdit', 'JJGPDF': 'Range', 'JNSPDL': 'Range', });
lyr_PENDIDIKAN_PT_50K_1.set('fieldLabels', {'NAMOBJ': 'inline label - always visible', 'LUAS': 'inline label - always visible', 'KATPDK': 'inline label - always visible', 'JLPDDK': 'inline label - always visible', 'FGGPDK': 'inline label - always visible', 'REMARK': 'inline label - always visible', 'FCODE': 'inline label - always visible', 'SRS_ID': 'inline label - always visible', 'LCODE': 'inline label - always visible', 'METADATA': 'inline label - always visible', 'JJGPDF': 'inline label - always visible', 'JNSPDL': 'inline label - always visible', });
